...
YEAR_CHOICES = range(2018-80, 2001)
...
#            'arrival': SelectDateWidget(months= {23:'September'}, years=['2018']),
#            'departure': SelectDateWidget(months= {28:'September'}, years=['2018']),
        }
    ...
    def send_email(self):
        message = "New registration for HTCC2018 was created. See at http://htcc2018.org/registration/register/list/"
        send_mail('New registration for HTCC2018 was created', message, settings.DEFAULT_FROM_EMAIL,
